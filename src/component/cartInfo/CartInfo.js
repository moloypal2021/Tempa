...
const CartInfo = () => {
  return (
    <div>
      <div className="border-b border-dark-boder pb-8">
        <h5 className="text-lg font-medium text-dark-title mb-3">
          1. Contact information
        </h5>
        <input
          className="border border-dark-light-border rounded-sm px-3 py-4 placeholder:text-sub w-full"
          placeholder="Email"
        />
      </div>
      <div className="border-b border-dark-boder pt-12 pb-8">
        <h5 className="text-lg font-medium text-dark-title mb-3">
          2. Delivery methods
        </h5>
        <div className="border border-dark-light-border divide-y">
          <div className="flex items-center px-6 py-4">
            <input type="checkbox" className="custom-check" id="ship" />
            <label htmlFor="ship" className="">
              Ship
            </label>
            <p className="text-base text-title-dark ml-auto">6,99$</p>
          </div>
          <div className="flex items-center px-6 py-4">
            <input type="checkbox" className="custom-check" id="pick" />
            <label htmlFor="pick" className="">
              Pick up
            </label>
            <p className="text-base text-title-dark ml-auto">4,99$</p>
          </div>
        </div>
      </div>
      <div className="border-b border-dark-boder pt-12 pb-8">
        ...
        <input
          className="border border-dark-light-border rounded-sm px-3 py-4 placeholder:text-sub w-full mb-4"
          placeholder="John"
        />
        <input
          className="border border-dark-light-border rounded-sm px-3 py-4 placeholder:text-sub w-full mb-4"
      ...
      <div className="border-b border-dark-boder pt-12 pb-8">
        <h5 className="text-lg font-medium text-dark-title mb-3">4. Payment</h5>
        <div className="border border-dark-light-border divide-y">
          <div className="flex items-center px-6 py-4">
          ...
          <div className="px-5">
            <input
              className="border border-dark-light-border rounded-sm px-3 py-4 placeholder:text-sub w-full my-4"
              placeholder="Phone number"
            />
          </div>
          <div className="flex items-center px-6 py-4">
            <input type="checkbox" className="custom-check" id="ideal" />
            <label htmlFor="ideal" className="">
              iDEAL
            </label>
